...
Aquí, el punto clave a notar es que un bucle while puede que no se ejecute. Cuando la condición es comprobada y su resutado es falso, el cuerpo del bucle será omitido y la primera declaración después de que el bucle while sea ejecutado. 
...
Mientras creamos un función en C, le damos una definición de lo que la fucnión tiene que hacer. Para usar una función, llamaremos a esa función para realizar una tarea definida. 
