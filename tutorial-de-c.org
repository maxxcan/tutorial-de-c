...
C soporta recursión, es decir, una función puede llamarse a sí misma. Pero mientras el uso de la recursión, los programadores necesitan ser cautelosos para definir una condición de salida desde la función, de otra forma se ejecutará un bucle infinito. 
...
El siguiiente ejemplo genera una serie de Fibonacci para un número dado usando una función recursiva - 
